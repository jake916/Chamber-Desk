...
const LawyerFunds = () => {
    ...
    return (
        <div className='p-6'>
            {isLoading ? (
                <LoadingSpinner message="Loading fund requisitions..." color="green" />
            ) : (
                <>
                    {/* Header */}
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button
                            onClick={() => navigate('/lawyer/funds/request')}
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="pl-10 pr-4 py-2.5 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-black"
                                />
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="pl-10 pr-8 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-black appearance-none bg-white min-w-[180px]"
                                >
                                            ...
                                            <tr key={req._id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 flex items-center gap-1"
                                                    >
                        ...
                        <div className="p-6 border-b border-gray-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <select
                                    ...
                                    className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 text-black text-sm"
                                >
                                ...
                                <div className="flex gap-2 col-span-1 lg:col-span-1">
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 text-black text-sm"
                                        />
                                    </div>
                                    <div className="flex-1">
                            ...
                            <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="bg-green-50 p-4 rounded-lg mb-4">
                                        ...
                                        <p className="text-3xl font-bold text-green-600">{formatCurrency(viewRequisition.amount)}</p>
                                    </div>
