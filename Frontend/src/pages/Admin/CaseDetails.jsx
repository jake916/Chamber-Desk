...
import {
    ...
    FolderOpen, Plus, Trash2, Download, Image as ImageIcon, File, Video, Music, X, UserPlus, ChevronRight, MessageCircle
} from 'lucide-react';
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                    ...
                    <div className="space-y-3">
                        {[...caseData.clientReports].reverse().map((report) => (
                            <div
                                key={report._id}
                                onClick={() => navigate(`/admin/cases/${id}/report/${report._id}`)}
