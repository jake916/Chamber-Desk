        ...
        <div className="p-6">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-amber-800 leading-relaxed">
                                ...
                                You can <strong>view case details and documents</strong> for your assigned task.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <button
                        onClick={() => navigate(`/paralegal/cases`)}
...
export default ParalegalCaseDetails;
