...
import { Briefcase, Search, Tag, Calendar, User, CheckCircle, Clock, FolderOpen, Award, XCircle } from 'lucide-react';
import API_BASE_URL from '../../config/api';

const ParalegalCases = () => {
    ...
    const getStatusColor = (status) => {
        const colors = {
            ...
            'Completed-Won': 'bg-teal-100 text-teal-700',
        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-gray-900">{pendingCases}</h3>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-gray-900">{closedCases}</h3>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-600 mb-1">Won Cases</p>
                            <h3 className="text-2xl font-bold text-gray-900">{wonCases}</h3>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-600 mb-1">Lost Cases</p>
                            <h3 className="text-2xl font-bold text-gray-900">{lostCases}</h3>
                        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <select
                        ...
                        className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-black"
                    >
            ...
            {filteredCases.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredCases.map((caseItem) => (
                        <div
                            key={caseItem._id}
                            onClick={() => navigate(`/paralegal/cases/${caseItem._id}`)}
