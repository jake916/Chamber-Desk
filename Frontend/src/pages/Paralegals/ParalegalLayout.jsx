...
import ParalegalSidebar from '../../components/Paralegal/ParalegalSidebar';
import API_BASE_URL from '../../config/api';

const ParalegalLayout = () => {
        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="fixed inset-0 bg-[#000000]/60 z-40 md:hidden" onClick={() => setSidebarOpen(false)}>
                    <div className="w-64 h-full" onClick={(e) => e.stopPropagation()}>
                        <div className="relative h-full">
                            ...
                            <ParalegalSidebar onNavigate={() => setSidebarOpen(false)} />
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className=" md:ml-64">
                ...
                <header className="bg-white shadow-sm p-4 flex justify-between items-center md:hidden">
                    ...
                    <button
                        onClick={() => window.location.href = '/paralegal/notifications'}
...
export default ParalegalLayout;
